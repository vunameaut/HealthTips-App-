...
public class Constants {
    ...
    public static final String VIDEOS_REF = "videos";
    public static final String TRENDING_VIDEOS_REF = "trendingVideos";
    public static final String USER_PREFERENCES_REF = "preferences";
